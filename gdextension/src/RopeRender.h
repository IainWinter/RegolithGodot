...
public:
    ...
    // pose is where the owner draws this frame, nodes lerp last to current
    // by fraction like the node's own interpolation. true when the multimesh
    // was made or grown and the item has to add it again
